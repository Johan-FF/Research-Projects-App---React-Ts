    ...
    >
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          <span className="flex w-full flex-col md:flex-row">
            <div className="h-[7vh] w-full flex justify-center items-center md:justify-start">
            ...
            <div className="h-[7vh] w-full flex justify-between flex-row md:flex-row-reverse md:justify-start">
              <Box
                sx={{
                  display: { xs: "flex", md: "none" },
                }}
              ...
              <div className="flex justify-between items-center flex-row">
                <Button
                  className="md:ml-3 bg-gradient-to-r from-secondary-dark h-min sm:h-auto"
                  color="inherit"
                >
